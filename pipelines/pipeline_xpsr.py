...
class StableDiffusionControlNetPipeline(DiffusionPipeline, TextualInversionLoaderMixin):
    ...
    def __call__(
        ...
        lowlevel_prompt: Union[str, List[str]] = None,
        ...
        lowlevel_prompt_embeds = self._encode_prompt(
            lowlevel_prompt,
            device,
            num_images_per_prompt,
            do_classifier_free_guidance,
            #negative_prompt="clean, high-resolution, high quality, sharp",
            negative_prompt="high resolution, best quality, clear",
            #negative_prompt="",
            prompt_embeds=None,
            negative_prompt_embeds=None,
        )
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if h*w<=tile_size*tile_size: #h<tile_size and w<tile_size: # tiled latent input
                    ...
                    _, _, down_block_res_samples, mid_block_res_sample, _ = self.controlnet(
                        controlnet_latent_model_input,
                        t,
                        encoder_hidden_states=controlnet_prompt_embeds,
                        lowlevel_encoder_hidden_states=lowlevel_prompt_embeds,
