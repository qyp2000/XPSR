    ...
    def __init__(self, 
        ...
        for index in range(start, end):
            for folder in os.listdir(f'{pngtxt_dir}/dataset_0/HR'):
                ...
                os.makedirs(f'{pngtxt_dir}/dataset_{str(index)}/lowlevel_prompt_q/{folder}', exist_ok=True)
                os.makedirs(f'{pngtxt_dir}/dataset_{str(index)}/lowlevel_prompt_q_GT/{folder}', exist_ok=True)
