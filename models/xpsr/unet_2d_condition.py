...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        up_use_lowlevel_prompt = [False, False, False, False],
        mid_use_lowlevel_prompt = False,
        down_use_lowlevel_prompt = False,
    ):
        super().__init__()
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            down_block = get_down_block(
                ...
                use_lowlevel_prompt = down_use_lowlevel_prompt,
            )
        ...
        if mid_block_type == "UNetMidBlock2DCrossAttn":
            self.mid_block = UNetMidBlock2DCrossAttn(
                ...
                upcast_attention=upcast_attention,
                attention_type=attention_type,
                use_lowlevel_prompt = mid_use_lowlevel_prompt,
            )
        ...
        for i, up_block_type in enumerate(up_block_types):
            ...
            up_block = get_up_block(
                ...
                cross_attention_norm=cross_attention_norm,
                attention_head_dim=attention_head_dim[i] if attention_head_dim[i] is not None else output_channel,
                use_lowlevel_prompt = up_use_lowlevel_prompt[i],
            )
    ...
    def forward(
        ...
        lowlevel_encoder_hidden_states: torch.Tensor,
